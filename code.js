...
DPIofYourDeviceScreen = 323; //you will need to measure or look up the DPI or PPI of your device/browser to make sure you get the right scale!!
  ...
  for(row = 0; row < 5; row++) {
    for(col = 0; col < 6; col++) {
        if(didMouseClick(width/2-createCanvasOfInputArea/2+col*createCanvasOfInputArea/6, height/2-createCanvasOfInputArea/2+row*createCanvasOfInputArea/6, createCanvasOfInputArea/6, createCanvasOfInputArea/6)) {
            currentLetter = String.fromCharCode(row*6+col+95);
